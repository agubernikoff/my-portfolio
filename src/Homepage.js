...
function Homepage() {
  return (
    <div id="top" className="flush-up">
      <h1 className="contact-name">ALEXANDER GUBERNIKOFF</h1>
      <div className="bio">
        <p>
        ...
        <p>
          In my free time, I enjoy all things pop culture, sports, and design.
        </p>
        <p>
          Please feel free to explore the site to learn more about me and my
          work.
        </p>
      </div>
    </div>
